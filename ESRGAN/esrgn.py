...
model_path = 'models/RRDB_ESRGAN_x4.pth' # models path
...
#model = arch.RRDBNet(in_channels, num_features, num_blocks, num_grow)
...
for it_path in glob.glob(test_img_folder):
    ...
    cv2.imwrite(os.path.join('results', '{:s}_rlt.png'.format(base)), output)